...
import com.fueldiet.fueldiet.fragment.StationsPricesListFragment;
...
public class StationPricesDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_station_prices_details);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setTitle("Fuel prices");

        Intent intent = getIntent();
        ArrayList<StationPriceObject> data = (ArrayList<StationPriceObject>) intent.getSerializableExtra("data");
        ...
        bottomNav.setOnNavigationItemSelectedListener(item -> {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.station_prices_list_all:
                    selectedFragment = new StationsPricesListFragment(data, names);
                    break;
            }
